...
const markupLetter = alphabet.map((element) => `<li class="hero__search-item">${element}</li>`).join("")
searchListLetterEl.innerHTML = markupLetter

const markupNumbers = numbers.map((element) => `<li class="hero__search-item">${element}</li>`).join("")
